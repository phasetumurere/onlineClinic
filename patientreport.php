                    ...
                    <div class="tab-pane" id="treatment" role="tabpanel">
                      ...
                      <div class="table-responsive dt-responsive">
                        <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                          ...
                          <?php
                          $sql = "SELECT * FROM treatment_records LEFT JOIN treatment ON treatment_records.treatmentid=treatment.treatmentid WHERE 
                          treatment_records.patientid=$_GET[patientid] AND 
                          treatment_records.appointmentid=$_GET[appointmentid]";
                          $qsql = mysqli_query($conn, $sql);

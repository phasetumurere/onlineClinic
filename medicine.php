                                ...
                                <div class="card-block">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="medicinename" id="medicinename" value="<?php if (isset($_GET['editid'])) {
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="medicinecost" id="medicinecost" value="<?php if (isset($_GET['editid'])) {
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" name="description" id="description"><?php if (isset($_GET['editid'])) {
